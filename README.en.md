...
2. **Human-readable views:** a dedicated Hardware Inventory screen with expandable fact cards and a user-started, page-local USB device tree, plus status, units, source, hardware domain, access level, compatibility evidence, five-stage readiness, Raw/Derived/Estimated/Calibrated labels, bounded history, search, and versioned JSON/CSV exports.
