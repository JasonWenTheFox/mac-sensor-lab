...
- No collection of serial numbers, hardware UUIDs, user/host names, network identifiers, USB locations/paths, precise location, process lists, or recordings. Sound Input Check retains or exports no PCM samples.
